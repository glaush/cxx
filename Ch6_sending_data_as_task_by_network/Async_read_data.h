...
void async_read_data(connection_ptr&& c, const Functor& f, std::size_t at_least_bytes)
{
	...
	boost::asio::async_read(
		...
		//boost::function < task_wrapped_with_connection<Functor>(std::move(c), f) >
		boost::bind(boost::lambda::constructor< task_wrapped_with_connection<Functor> >(), c, f)
...
template <class Functor>
void async_read_data_at_least(connection_ptr&& c, const Functor& f,
